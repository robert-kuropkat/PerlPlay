...
timethese ( $sortCylces
          , { bubbleMe  => 'bubblesort_me(["wilma", "fred", "barney", "bam-bam", "pebbles", "dino"])'
            , bubbleJon => 'bubblesort_jon(["wilma", "fred", "barney", "bam-bam", "pebbles", "dino"])'
            , bubbleDon => 'bubblesort_don(["wilma", "fred", "barney", "bam-bam", "pebbles", "dino"])'
            }
          );
